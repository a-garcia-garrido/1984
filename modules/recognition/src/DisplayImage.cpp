...
void detectAndDisplay(Mat frame)
{
    ...
    for (ic = 0; ic < faces.size(); ic++) // Iterate through all current elements (detected faces)
    {
        ...
        imwrite(filename, gray); // Save detected area in folder
    ...
    // Show image
    putText(frame, "Press any key to continue.", cvPoint(30, 30), FONT_HERSHEY_COMPLEX_SMALL, 0.8, cvScalar(0, 0, 255), 1, CV_AA);
